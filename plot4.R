...
# 4. Créer un graphique : plot4 : All plots ####

png("plot4.png", width = 480, height = 480, units = "px")
par(mfrow = c(2,2))

with(feb.data, plot(Date_Heure, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))
with(feb.data, plot(Date_Heure, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))
...
with(feb.data, plot(Date_Heure, Global_reactive_power, xlab = "datetime", type = "l", ylab = "Global_reactive_power"))
